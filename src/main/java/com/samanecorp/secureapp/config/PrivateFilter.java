...
public class PrivateFilter implements Filter {
	...
	public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException, ServletException {
		...
		if (username != null || path.equals("/") || path.equals("/login")|| path.equals("/sigup") || path.equals("/logout") || path.equals("/index.jsp") || path.equals("/login") && method.equalsIgnoreCase("POST") || path.equals("/singup") && method.equalsIgnoreCase("POST") || path.startsWith("/public/"))
